...
import ru.android.healthvector.domain.development.testing.data.interpreters.AutismTestInterpreter;
import ru.android.healthvector.domain.development.testing.data.interpreters.DomanMentalTestInterpreter;
import ru.android.healthvector.domain.development.testing.data.interpreters.DomanPhysicalTestInterpreter;
import ru.android.healthvector.domain.development.testing.data.interpreters.NewbornTestInterpreter;
import ru.android.healthvector.domain.development.testing.data.interpreters.core.TestInterpreter;
import ru.android.healthvector.domain.development.testing.data.processors.AutismTestProcessor;
...
import ru.android.healthvector.domain.development.testing.data.tests.AutismTest;
