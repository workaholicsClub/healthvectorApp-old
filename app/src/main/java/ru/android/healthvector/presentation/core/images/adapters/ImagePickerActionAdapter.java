package ru.android.healthvector.presentation.core.images.adapters;
...
public class ImagePickerActionAdapter extends BaseArrayAdapter<ImagePickerAction, ImagePickerActionAdapter.ViewHolder> {
