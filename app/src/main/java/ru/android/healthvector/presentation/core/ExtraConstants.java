...
public class ExtraConstants {
    ...
    public static final String EXTRA_EVENT_TYPE = PACKAGE_NAME + ".event_type";
    ...
    public static final String EXTRA_EVENT_NOTIFICATION = PACKAGE_NAME + ".event_notification";
}
