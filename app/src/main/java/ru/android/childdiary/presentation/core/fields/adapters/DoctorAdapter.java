...
public class DoctorAdapter extends BaseArrayAdapter<Doctor, DoctorAdapter.ViewHolder> {
    ...
    @Override
    protected DoctorAdapter.ViewHolder createViewHolder(View view) {
        return new DoctorAdapter.ViewHolder(view);
    }

    static class ViewHolder extends BaseViewHolder<Doctor> {
        ...
        @Override
        public void bind(Context context, int position, Doctor doctor) {
            String text = doctor == Doctor.NULL
