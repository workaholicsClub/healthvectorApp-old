...
public class AllEventsMapper implements EntityMapper<Tuple, Tuple, MasterEvent> {
    ...
    public static DoctorVisit mapToDoctorVisit(@NonNull Tuple data) {
        return DoctorVisit.builder()
                ...
                .finishDateTime(data.get(DoctorVisitEntity.FINISH_DATE_TIME.as("doctor_visit_finish_date_time")))
                .exported(data.get(DoctorVisitEntity.EXPORTED.as("doctor_visit_exported")))
    ...
    public static MedicineTaking mapToMedicineTaking(@NonNull Tuple data) {
        return MedicineTaking.builder()
                ...
                .finishDateTime(data.get(MedicineTakingEntity.FINISH_DATE_TIME.as("medicine_taking_finish_date_time")))
                .exported(data.get(MedicineTakingEntity.EXPORTED.as("medicine_taking_exported")))
